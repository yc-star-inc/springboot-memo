...
ALTER TABLE PPMSDM.RAWMAT_PRE_BATCH_STATUS ALTER "DEFECT_MATCH_STATUS"  VARCHAR2 (15 BYTE)
ALTER TABLE PPMSDM.RAWMAT_PRE_BATCH_STATUS ALTER "SPC_MATCH_STATUS"  VARCHAR2 (15 BYTE)
ALTER TABLE PPMSDM.RAWMAT_PRE_BATCH_STATUS ALTER "FAC_MATCH_STATUS"  VARCHAR2 (4 BYTE)
